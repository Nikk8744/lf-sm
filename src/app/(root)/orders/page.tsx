...
import { RecipeButton } from "@/components/recipe-chat/recipe-button";
  ...
  return (
    <div className="container mx-auto py-12 px-4">
      <div className="flex justify-between items-center mb-8">
        ...
        <Button onClick={() => router.push("/products")} variant="myVariantBtn">
          Continue Shopping
        </Button>
      </div>
            ...
            >
              ...
              <CardFooter className="p-6">
                ...
                <div className="flex gap-2 mx-2 p-2">
                  <RecipeButton orderId={order.id} orderItems={order.items} />
                  {/* Other buttons */}
                </div>
              </CardFooter>
            </Card>
